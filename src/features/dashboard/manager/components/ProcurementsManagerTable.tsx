...
import { ChevronDownIcon, ColumnsIcon, Eye, FilterIcon } from "lucide-react";
    ...
    >
      {row.getVisibleCells().map((cell) => {
        ...
        if (cell.column.id === "index")
          ...
          cellClass += " min-w-[90px] sm:w-40 text-sm sm:text-sm text-center";
...
export function ProcurementsManagerTable() {
  ...
  const columns: ColumnDef<Procurement>[] = [
    ...
    },
    {
      ...
      header: () => (
        <div className="text-center text-xs sm:text-xs font-semibold uppercase tracking-wider">
          <span className="hidden sm:inline">Tanggal Dibuat</span>
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex justify-center">
          <Button
            variant="ghost"
            className="text-primary hover:bg-primary/10 flex h-8 w-8 sm:h-8 sm:w-8"
            size="icon"
      ...
      <div className="flex flex-col gap-4 sm:gap-4">
        <div className="flex flex-col gap-3 sm:gap-4 md:flex-row md:items-center md:justify-between">
          <Input
            ...
            className="w-full md:max-w-3xl text-sm h-10"
          />
                    ...
                    <TableRow key={headerGroup.id}>
                      {headerGroup.headers.map((header) => {
                        ...
                        if (header.id === "index")
                          ...
                          headerClass += " min-w-[90px] sm:w-40";

...
import { ChevronDownIcon, ColumnsIcon, Eye } from "lucide-react";
import React, { useState } from "react";
import { useDebounceValue } from "usehooks-ts";
import ModalDetailSection from "../../dirops/components/DetailModalSection";
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex justify-center">
          <Button
            variant="ghost"
            className="text-primary hover:bg-primary/10 flex size-8"
            size="icon"
